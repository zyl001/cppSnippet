...
enum Person_PhonType {
  Person_PhonType_MOBILE = 0,
  Person_PhonType_HOME = 1,
  Person_PhonType_WORK = 2
};
bool Person_PhonType_IsValid(int value);
const Person_PhonType Person_PhonType_PhonType_MIN = Person_PhonType_MOBILE;
const Person_PhonType Person_PhonType_PhonType_MAX = Person_PhonType_WORK;
const int Person_PhonType_PhonType_ARRAYSIZE = Person_PhonType_PhonType_MAX + 1;

const ::google::protobuf::EnumDescriptor* Person_PhonType_descriptor();
inline const ::std::string& Person_PhonType_Name(Person_PhonType value) {
  return ::google::protobuf::internal::NameOfEnum(
    Person_PhonType_descriptor(), value);
}
inline bool Person_PhonType_Parse(
    const ::std::string& name, Person_PhonType* value) {
  return ::google::protobuf::internal::ParseNamedEnum<Person_PhonType>(
...
class Person_PhoneNumber : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:addressbook.Person.PhoneNumber) */ {
 public:
  ...
  // optional .addressbook.Person.PhonType type = 2 [default = HOME];
  bool has_type() const;
  void clear_type();
  static const int kTypeFieldNumber = 2;
  ::addressbook::Person_PhonType type() const;
  void set_type(::addressbook::Person_PhonType value);
...
inline ::addressbook::Person_PhonType Person_PhoneNumber::type() const {
  // @@protoc_insertion_point(field_get:addressbook.Person.PhoneNumber.type)
  return static_cast< ::addressbook::Person_PhonType >(type_);
}
inline void Person_PhoneNumber::set_type(::addressbook::Person_PhonType value) {
  assert(::addressbook::Person_PhonType_IsValid(value));
  set_has_type();
  type_ = value;
...
template <> struct is_proto_enum< ::addressbook::Person_PhonType> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::addressbook::Person_PhonType>() {
  return ::addressbook::Person_PhonType_descriptor();
}
